...
var SPL_META_EVENT_KEY = exports.SPL_META_EVENT_KEY = 'splunk.meta_event';
var SPL_META_PROPAGATION_KEY = exports.SPL_META_PROPAGATION_KEY = 'splunk.propagation_format';
var SPL_META_TRACE_KEY = exports.SPL_META_TRACE_KEY = 'splunk.trace_id';
var SPL_META_SPAN_KEY = exports.SPL_META_SPAN_KEY = 'splunk.span_id';
var SPL_META_TRACER_GUID_KEY = exports.SPL_META_TRACER_GUID_KEY = 'splunk.tracer_guid';
var SPL_META_EXTRACT = exports.SPL_META_EXTRACT = 'splunk.extract_span';
var SPL_META_INJECT = exports.SPL_META_INJECT = 'splunk.inject_span';
var SPL_META_SP_START = exports.SPL_META_SP_START = 'splunk.span_start';
var SPL_META_SP_FINISH = exports.SPL_META_SP_FINISH = 'splunk.span_finish';
var SPL_META_TRACER_CREATE = exports.SPL_META_TRACER_CREATE = 'splunk.tracer_create';
...
var kRuntimeGUIDCookiePrefix = 'splunk_guid';
var kSessionIDCookieKey = 'splunk_session_id';
...
var TransportBrowser = function () {
    ...
    _createClass(TransportBrowser, [{
        ...
        value: function _reportAJAX(auth, report, done) {
            var reportJSON = report.toJSON(auth);
            var protocol = this._encryption === 'none' ? 'http' : 'https';
            var url = protocol + '://' + this._host + ':' + this._port + '/services/collector';
...
var SpanImp = function (_opentracing$Span) {
    ...
    _createClass(SpanImp, [{
        ...
        value: function generateTraceURL() {
            ...
            var urlPrefix = constants.SPLUNK_APP_URL_PREFIX;
...
var DEFAULT_COLLECTOR_HOSTNAME = '127.0.0.1';
var DEFAULT_COLLECTOR_PORT_TLS = 8088;
var DEFAULT_COLLECTOR_PORT_PLAIN = 8088;
...
var Util = function () {
    ...
    _createClass(Util, [{
        ...
        value: function shouldSendMetaSpan(opts, tags) {
            var shouldSendSpan = opts.meta_event_reporting === true && tags['splunk.meta_event'] !== true;
...
if (true) {
    module.exports = {
        ...
        HTTPTransport: __webpack_require__(/*! ./imp/platform/browser/transport_httpjson.js */ "./src/imp/platform/browser/transport_httpjson.js")
    };
} else {}
...
//# sourceMappingURL=splunk-tracer.js.map