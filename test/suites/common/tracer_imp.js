function makeSPLTracer(extraOpts) {
    var opts = {
    ...
    return new splunktracing.Tracer(opts);
}
...
describe("TracerImp", function() {
    describe("TracerImp#options", function() {
        ...
        it('should default to an empty base path', function() {
            expect(makeSPLTracer().options().collector_path).to.equal('');
        });
